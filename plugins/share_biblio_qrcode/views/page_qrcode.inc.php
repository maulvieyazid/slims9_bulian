...
<head>
    ...
    <title>Pustaka Nusantara | Pustara</title>
    <style>
        @media print {
...
<body>
        ...
        <div class="header">
            <div class="logo">
                <div class="book-cover-placeholder">
                    <img src="<?= \Slims\Url::getSlimsBaseUri('images/default/logo.png') ?>" alt="Logo IKN" srcset="">
                </div>
            </div>
            <div class="title" id="bookTitle"><?= 'Pustaka Nusantara' ?></div>
        </div>
    ...
    <script>
        ...
        qrcode.makeCode(`<?= \SLiMS\Url::getSlimsBaseUri() ?>`);
    </script>
    <script>
